...
export default function ProfessionalsError({
  ...
  useEffect(() => {
    console.error('Professionals page error:', error);
  }, [error]);
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-violet-50 flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-4">
          Hiba történt a Hasznos szakemberek oldal betöltése közben
        </h2>
        <p className="text-gray-600 mb-8">
          Sajnáljuk, de nem sikerült betölteni a szakembereket. Kérjük,
          próbálja meg újra.
        </p>
